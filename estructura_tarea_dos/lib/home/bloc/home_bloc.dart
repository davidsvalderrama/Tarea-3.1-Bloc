...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  List<TodoRemainder> _loadReminders() {
    ...
    Map<dynamic, dynamic> temp = _configBox.toMap();
    List remaindersList = temp.values.toList();
    if (remaindersList.isNotEmpty) {
      return remaindersList.cast<TodoRemainder>();
    }
    throw EmptyDatabase();
  }
